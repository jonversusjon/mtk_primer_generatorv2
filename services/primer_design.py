...
#     print(f"\n📌 Calling get_all_possible_internal_primers with:")
#     print(f"   - seq_index: {seq_index}")
#     print(f"   - part_num_left: {part_num_left}, part_num_right: {part_num_right}")
#     print(f"   - proposed_mutations: {proposed_mutations.keys()}")
    
#     if not proposed_mutations:
#         print("❌ proposed_mutations is empty! Something went wrong.")
#         return {}  # Exit early if no mutations were selected
...
#         print(f"\n🔍 Processing site_index: {site_index}")
...
#             print(f"  ➡ Processing codon_start: {codon_start}, mutations: {mutations}")
